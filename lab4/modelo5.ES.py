...
if __name__ == "__main__":
    ...
    patience = 20  # Número de épocas que esperamos sin mejoras
    ...
    for epoch in range(num_epochs):
        ...
        # Early stopping: si la pérdida de validación mejora, reseteamos el contador de paciencia
        ...
        # Si hemos alcanzado el límite de paciencia, paramos el entrenamiento
